...
internal sealed class CreateQuestionValidator : AbstractValidator<CreateQuestionCommand>
{
    public CreateQuestionValidator()
    {
        ...
        // A LaTeX body is required only when no image is supplied — an image-only question is valid (FR-PLAT-QB-002).
        ...
        // When an image is supplied inline, enforce the same type/size limits as the multipart image upload.
