...
description: Create new Angular applications using the Angular CLI with modern best practices. Use when a user wants to create a new Angular project, scaffold an application, or set up an Angular workspace from scratch. Triggers on requests to create, start, initialize, or bootstrap a new Angular app. Do not use for modifying existing projects or adding features to existing apps.
---

# Angular New App

## **IMPORTANT** Always use `#` instead of the `private` keyword for private fields
...
5. To add tailwind, run `npx ng add tailwindcss`. After that, you do not have to do anything else, you can start using tailwind classes in your Angular application. Follow the best practices for tailwind v4.
